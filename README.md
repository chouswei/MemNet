...
**Durable:** optional client `memnet-llm[agensgraph]`; cabinet is external and not vendored. Live cabinet is a **1.0.0** durable gate (not claimed; does not block 0.5). **1.0.0** as a whole = mature tool — see [`docs/ROADMAP.md`](docs/ROADMAP.md).

## Deferred (honest)

- Live AgensGraph cabinet (client hydrate/flush exists; live path is a **1.0.0** durable gate, not a 0.5 lock; 1.0 also needs leftover goldfish)
...
| [`docs/ROADMAP.md`](docs/ROADMAP.md) | All versions; 1.0 = mature tool |
