...
Product **`memnet-llm` 0.19.1**. Last published PyPI wheel is **0.19.0** until coordinator uploads **0.19.1**. Tools return JSON text. Arg **`session`** (not `session_id`). SSOT: `parts/memnet-mcp/software/memnet_mcp/server.py`.
