...
1. Install **0.19**: `pip install 'memnet-llm[mcp]'` (Hatch **0.19.1**; pin `==0.19.1` after PyPI upload, else last wheel is **0.19.0**). Optional `[neo4j]` (live claimed 0.14; drivers only). Contributors: `pip install -e ".[mcp]"`.
