...
| Neo4j durable client (`memnet-llm[neo4j]`) | Extra **0.14** `liveNeo4jClaimed=true` (this repo) |
...
| Teaching full ACL modes / HostSearch as available | Full ACL modes still design; HostSearch is extra **0.17** locators only |
