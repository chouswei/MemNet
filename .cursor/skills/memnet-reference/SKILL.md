...
**Product:** Hatch **0.19.6** (CLI `memnet`). Published PyPI wheel is **`memnet-llm==0.19.6`**. Version map: `docs/ROADMAP.md`. Shape: `docs/SHAPE.md`. **1.0** = 0.5–0.8 claimed (do not tag from this skill).
