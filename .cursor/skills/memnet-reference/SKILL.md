...
**Product:** Hatch **0.19.7** (CLI `memnet`). Last published PyPI wheel is **`memnet-llm==0.19.6`** until this cut is uploaded. Version map: `docs/ROADMAP.md`. Shape: `docs/SHAPE.md`. **1.0** = 0.5–0.8 claimed (do not tag from this skill).
