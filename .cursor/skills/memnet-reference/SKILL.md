...
**Product:** Hatch **0.19.3** (CLI `memnet`). Last PyPI **`memnet-llm==0.19.0`** until upload. Version map: `docs/ROADMAP.md`. Shape: `docs/SHAPE.md`. **1.0** = 0.5–0.8 claimed (do not tag from this skill).
