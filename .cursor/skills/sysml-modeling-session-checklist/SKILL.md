...
1. **Root** — `sysml-models/config.yaml` and files to touch (`implementation.sysml` when tracking SSOT → code). [read policy](../sysml-memnet-documentation/references/sysml-memnet-read-policy.md). SSOT→code ledger: [sysml-ssot-to-code](../sysml-ssot-to-code/SKILL.md).
