...
- **Sessions as strata (design)** — partition haystacks into named sessions; goldfish one \(S\); join Absorb a slice. Not Layer / Tier A. [`docs/grammar/memnet-session-strata.md`](docs/grammar/memnet-session-strata.md).
