...
### Changed
- **RAG / Neo4j rethink (design)** — [`docs/grammar/memnet-neo4j-rag-rethink.md`](docs/grammar/memnet-neo4j-rag-rethink.md): two haystacks vs three stores; propose option B (namespace law + library-port steal/reject); estimates for network, RAM, CPU, LLM tokens.
