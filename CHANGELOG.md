...
### Added
- **Harness thesis (design)** — MemNet as the **memory plane of an agent harness**; **token law** = few tokens to Shape named facts and sparse-Commit \(S\) (not RAG top‑\(k\)). [`docs/grammar/memnet-harness-thesis.md`](docs/grammar/memnet-harness-thesis.md).
