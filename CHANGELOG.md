...
### Changed
- **Docs layout (job folders)** — Live docs stay; they sit under `docs/grammar/` (GQL wire + math), `docs/cabinet/` (durable adapters), `docs/extras/` (numbered extras / ACL design), `docs/operations/` (Multitask), `docs/application-notes/{system,domains,examples}/`. Index load order: [`docs/README.md`](docs/README.md). Historical changelog rows keep old paths (`LAYOUT.md`). Do not restore Layer / archive folders.
