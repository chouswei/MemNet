...
- **Package identity 0.19.14** — Hatch / `project.toml` / `memnet.__version__` honesty cut on **0.19**. Hatch and PyPI are both **`memnet-llm==0.19.14`** (published 2026-09-24). Honesty `c` is TTL expire restore by known sid.
...
[Unreleased]: https://github.com/chouswei/MemNet/compare/v0.19.11...HEAD
