...
- **Recall/Commit orthodox plan (docs)** — theorems as a base to build from; paradox cases V1–V10; leftover goldfish sequence (#73, union-under-one-\(M\)) **beside** M2.5, not instead. `sysml-models/outputs/recall-commit-orthodox-plan.md`.
