...
- **Roadmap one picture + 0.10–0.17 plan** — [`docs/ROADMAP.md`](docs/ROADMAP.md): memory plane vs outer harness vs RAG vs cabinet; **1.0 = claim 0.5–0.8** (MAY tag from 0.9). Numbered extras: 0.10 caller contract; 0.11 live Neo4j; 0.12 catalog Snap **and session strata**; 0.13 two namespaces; 0.14 HostSearch locators; 0.15 Peak_L; 0.16 export; 0.17 N-server. Do not hold 1.0 for those rows.
...
- **Version map locked** — 0.8 = GQL teach + shape for people; **0.9** = Neo4j client extra (live unclaimed); 1.0 = 0.5–0.8 claimed; Later = Peak_L / HostSearch / N-server / export / hosted cabinet / live Neo4j. SSOT: `docs/ROADMAP.md`.
