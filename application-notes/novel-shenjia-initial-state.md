...
@PLR: id|玩家身份|出生年|性別|財產|淨銀流|核心靈魂能力|身體狀態
@BIZ: id|名稱|類型|地點|現金|負債|收入|支出|回收
@NPC: id|名字|出生年|性別|外觀|性格|語氣|特徵|腐敗|工藝|技能|物品|資金缺口|狀態|回收
@SKL: id|角色|名稱|品級|回收
...
@NPC: N01|沈芯|1625|女|美貌、滿臉炭灰|聰慧、堅韌、溫柔、慾念|沉穩簡約|匠戶孤女、繼承經營沈家鐵坊、僅土法|0|土法|打鐵:略有小成；看火:熟能生巧；識鐵:略有小成|鐵鉗:1；護手布:1；木勺:1|0|需小工|常駐
@NPC: N02|沈蘭|1627|女|美貌、滿臉炭灰|狡黠、大膽、開放|潑辣帶笑|匠戶孤女、協助鐵坊|0|土法|打鐵:初学乍練；燒火:初学乍練；跑腿:熟能生巧|油燈:1；布兜:1|0|需小工|常駐
...
- **角色對白與內心（LAW-CHR00–03 + USR24 + `@NPC`／`@PRS`）：** 沈芯偏沉穩簡約；沈蘭偏潑辣帶笑（寫在 `@NPC.語氣`；性格見 `.性格`；身分標籤見 `.特徵`）。主角內心走現代台灣白話；對外說話以時代為主，偶有現代思維露餡。
- **身體狀態與劇情（USR45 + LAW-VIT01 + `@PLR.身體狀態`）：** HUD 尾欄與圖上 `@PLR` 第 8 欄（`氣血`／`內力`／`內功`／`武學`／`輕功`／`飽食`／`疲勞` 等）**不是裝飾**，每拍必納入編排與正文。性別在第 4 欄，與 `USR53` 同步，勿再寫入身體狀態字串。
