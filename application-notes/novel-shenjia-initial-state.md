...
| **接線** | `@EDG` | `governs`／`features`＝引擎；其餘 relation＝劇情／經濟／人設 |
...
@SKL: id|角色|名稱|品級|回收
@WUX: id|角色|門類|品級|當值|回收
@ART: id|名稱|門類|金庸梯|係數|出處|回收
@MWU: id|角色|武功|熟練度|當值|回收
@ITM: id|角色|名稱|數量|回收
@TSK: id|目標|時限|狀態|回收
@TEC: id|名稱|領域|狀態|效果
...
@LAW: LAW-BAN01|*|on_turn|no_loop|gate_metrics
@LAW: LAW-BAN02|*|on_turn|no_manual|chapter_append
@LAW: LAW-BAN03|*|on_turn|no_prose|before_finish_ok
...
@LAW: LAW-WX01|*|on_turn|wuxia_cite|cite_wux_usr04_plr_step2
@LAW: LAW-WX02|PLR|on_turn|neili_toll|low_neili_visible_cost
@LAW: LAW-WX03|*|on_pick|martial_resolve|wux_rank_trait_neili_age
@LAW: LAW-WX04|*|on_context|soul_body_cap|min_mwu_wux_age_neili
@LAW: LAW-WX05|*|on_pick|exchange_resolve|margin_eff_wux_vs_opp;cite_usr35_36_37_art
@LAW: LAW-WX06|*|on_pick|exchange_toll|qi_neili_fatigue_by_margin;mode_scale_usr35
@LAW: LAW-WX07|*|on_context|opp_wux_rank|npc_skill_oln_dc;usr28_idx;cite_art
@LAW: LAW-WX08|*|on_context|art_coeff|k_by_jinyong_tier;cite_art_usr38_39
@LAW: LAW-WX09|*|on_pick|art_toll|neili_scale_by_art;cite_usr40
@LAW: LAW-WX10|*|on_pick|mwx_gain|milestone_only;cite_usr41
@LAW: LAW-WX11|PLR|on_turn|neigong_recover|cite_usr46;art01_taixuan;vit_finish_delta
@LAW: LAW-CHR02|NPC|on_turn|npc_voice|cite_npc_traits_prs_pty;sys_minus_birth
@LAW: LAW-CHR03|NPC|on_turn|npc_dialogue|no_tagline_no_clip;age_fit_addr;cite_law_tec01
@LAW: LAW-CHR04|*|on_turn|trait_age_bind|sys_minus_birth;body_dialogue_addr
@LAW: LAW-CHR01|PLR|on_turn|plr_voice|cite_usr18_usr19_usr24_usr25
...
@USR: USR04|skills|太玄經初学乍練、獨孤九劍初学乍練、六脈神劍初学乍練、靈魂圖書館登峰造極、凌波微步初学乍練|persistent
...
@USR: USR46|neigong_recover|ART01;MWU01;WUX01;半時辰一輪|persistent
...
@EDG: EG124|USR26|governs|LAW-WX01||persistent
@EDG: EG125|USR26|governs|LAW-WX02||persistent
@EDG: EG126|USR26|governs|LAW-WX03||persistent
@EDG: EG127|USR26|governs|LAW-WX04||persistent
@EDG: EG128|STEP01|governs|LAW-WX01||persistent
@EDG: EG129|USR29|governs|LAW-WX03||persistent
@EDG: EG130|USR29|governs|LAW-WX04||persistent
@EDG: EG131|P01|governs|LAW-WX02||persistent
@EDG: EG132|USR04|governs|LAW-WX01||persistent
@EDG: EG133|USR28|governs|LAW-WX03||persistent
@EDG: EG134|STEP01|governs|USR30||persistent
@EDG: EG135|USR30|governs|LAW-OPT01||persistent
@EDG: EG136|STEP01|governs|LAW-OPT01||persistent
@EDG: EG137|STEP01|governs|LAW-OPT02||persistent
@EDG: EG138|STEP01|governs|LAW-OPT03||persistent
@EDG: EG139|STEP01|governs|LAW-LIB01||persistent
@EDG: EG140|STEP01|governs|LAW-LIB02||persistent
@EDG: EG141|USR31|governs|LAW-LIB01||persistent
@EDG: EG142|USR04|governs|LAW-LIB01||persistent
@EDG: EG143|USR30|governs|GLO08||persistent
@EDG: EG144|LAW-G05|governs|LAW-LIB01||persistent
@EDG: EG145|LAW-G05|governs|LAW-OPT03||persistent
@EDG: EG146|USR32|governs|LAW-PERS02||persistent
@EDG: EG147|USR33|governs|LAW-PERS03||persistent
@EDG: EG148|USR34|governs|LAW-PERS04||persistent
@EDG: EG149|STEP01|governs|LAW-PERS04||persistent
@EDG: EG150|USR34|governs|LAW-WX03||persistent
@EDG: EG151|STEP01|governs|LAW-WX05||persistent
@EDG: EG152|USR26|governs|LAW-WX05||persistent
@EDG: EG153|USR29|governs|LAW-WX05||persistent
@EDG: EG154|USR35|governs|LAW-WX05||persistent
@EDG: EG155|USR36|governs|LAW-WX05||persistent
@EDG: EG156|USR37|governs|LAW-WX05||persistent
@EDG: EG157|USR28|governs|LAW-WX05||persistent
@EDG: EG158|LAW-WX05|governs|LAW-WX06||persistent
@EDG: EG159|STEP01|governs|LAW-WX06||persistent
@EDG: EG160|USR35|governs|LAW-WX06||persistent
@EDG: EG161|USR28|governs|LAW-WX07||persistent
@EDG: EG162|STEP01|governs|LAW-WX07||persistent
@EDG: EG163|LAW-NPC02|governs|LAW-WX07||persistent
@EDG: EG164|USR34|governs|LAW-WX05||persistent
@EDG: EG165|STEP01|governs|LAW-WX08||persistent
@EDG: EG166|USR26|governs|LAW-WX08||persistent
@EDG: EG167|USR38|governs|LAW-WX08||persistent
@EDG: EG168|USR39|governs|LAW-WX08||persistent
@EDG: EG169|LAW-WX08|governs|LAW-WX05||persistent
@EDG: EG170|LAW-WX08|governs|LAW-WX07||persistent
@EDG: EG171|USR40|governs|LAW-WX09||persistent
@EDG: EG172|STEP01|governs|LAW-WX09||persistent
@EDG: EG173|LAW-WX09|governs|LAW-WX06||persistent
@EDG: EG174|USR04|governs|LAW-WX08||persistent
@EDG: EG175|STEP01|governs|LAW-WX10||persistent
@EDG: EG176|USR41|governs|LAW-WX10||persistent
@EDG: EG177|USR41|governs|LAW-WX04||persistent
@EDG: EG178|USR28|governs|LAW-WX10||persistent
@EDG: EG179|LAW-WX10|governs|LAW-PERS03||persistent
@EDG: EG180|STEP01|governs|LAW-PERS05||persistent
@EDG: EG181|USR42|governs|LAW-PERS05||persistent
@EDG: EG182|USR42|governs|LAW-WX05||persistent
@EDG: EG183|USR42|governs|LAW-PERS04||persistent
@EDG: EG184|USR41|governs|LAW-PERS05||persistent
@EDG: EG185|USR33|governs|LAW-PERS05||persistent
...
@EDG: EG191|LAW-TEC01|governs|LAW-CHR03||persistent
@EDG: EG192|GLO09|governs|LAW-CHR03||persistent
...
@EDG: EG197|LAW-VIT01|governs|LAW-PERS04||persistent
...
@EDG: EG205|MWU01|governs|LAW-WX11||persistent
@EDG: EG206|P01|governs|LAW-WX11||persistent
@EDG: EG207|LAW-WX11|governs|LAW-VIT01||persistent
@EDG: EG208|USR40|governs|LAW-WX11||persistent
...
@EDG: EG212|USR49|governs|LAW-WX09||persistent
@EDG: EG213|LAW-VIT02|governs|LAW-VIT01||persistent
@EDG: EG214|LAW-VIT02|governs|LAW-WX02||persistent
...
@EDG: EG218|LAW-VIT03|governs|LAW-OPT01||persistent
@EDG: EG219|LAW-VIT03|governs|LAW-WX05||persistent
@EDG: EG220|LAW-VIT03|governs|LAW-WX11||persistent
...
@EDG: EG66|STEP01|governs|LAW-BAN01||persistent
@EDG: EG67|STEP01|governs|LAW-BAN02||persistent
@EDG: EG68|STEP01|governs|LAW-BAN03||persistent
...
@EDG: EG80|SYS01|governs|LAW-NAME02||persistent
@EDG: EG81|STEP01|governs|LAW-NAME02||persistent
...
@EDG: EG92|USR22|governs|LAW-PERS02||persistent
...
@PLR: P01|流民乞丐|1627|0|0|靈魂圖書館登峰造極、太玄經初学乍練、獨孤九劍初学乍練、六脈神劍初学乍練、凌波微步初学乍練|氣血:6/6；內力:0/4；內功:未入門；武學:初学乍練；輕功:初学乍練；飽食:略飽；疲勞:0；魂穿:21世紀台灣工程師；靈魂圖書館:意識深處知識殿堂

@BIZ: B01|沈家鐵坊|鐵匠鋪|江南河畔|0|2|0|0|常駐

@NPC: N01|沈芯|1625|女、美貌、滿臉炭灰、孤女、聰慧、堅韌、溫柔、慾念、僅土法匠戶|0|土法|打鐵:略有小成；看火:熟能生巧；識鐵:略有小成|鐵鉗:1；護手布:1；木勺:1|0|需小工|常駐
@NPC: N02|沈蘭|1627|女、美貌、滿臉炭灰、孤女、狡黠、大膽、開放|0|土法|打鐵:初学乍練；燒火:初学乍練；跑腿:熟能生巧|油燈:1；布兜:1|0|需小工|常駐
...
@ART: ART04|凌波微步|輕功|一流|1.70|天龍;步法;幾不能傷敵;pool薄;burn1;sustain4|常駐
...
@ART: ART14|易筋經|內功|絕頂|1.95|天龍;佛門至高;pool厚;burn1;sustain6|常駐
...
@MWU: MWU01|P01|ART01|初学乍練|1|常駐
@MWU: MWU02|P01|ART02|初学乍練|1|常駐
@MWU: MWU03|P01|ART03|初学乍練|1|常駐
@MWU: MWU04|P01|ART04|初学乍練|1|常駐

@WUX: WUX01|P01|內功|未入門|0|常駐
@WUX: WUX02|P01|武學|初学乍練|1|常駐
@WUX: WUX03|P01|輕功|初学乍練|1|常駐
...
@EDG: EA01|P01|soul_knows|ART01||persistent
@EDG: EA02|P01|soul_knows|ART02||persistent
@EDG: EA03|P01|soul_knows|ART03||persistent
@EDG: EA04|P01|soul_knows|ART04||persistent

@EDG: EM01|P01|has_mwu|MWU01||persistent
@EDG: EM02|P01|has_mwu|MWU02||persistent
@EDG: EM03|P01|has_mwu|MWU03||persistent
@EDG: EM04|P01|has_mwu|MWU04||persistent
@EDG: EM11|MWU01|for_art|ART01||persistent
@EDG: EM12|MWU02|for_art|ART02||persistent
@EDG: EM13|MWU03|for_art|ART03||persistent
@EDG: EM14|MWU04|for_art|ART04||persistent

@EDG: EW01|P01|has_wux|WUX01||persistent
@EDG: EW02|P01|has_wux|WUX02||persistent
@EDG: EW03|P01|has_wux|WUX03||persistent
@EDG: EP50|P01|primary_neigong|ART01|太玄主修|persistent
...
| `USR27–29` + `LAW-WX01–10` | **武學判定**：三維＋**`@MWU` 各招熟練度**；`@ART` 金庸梯係數；過招＝cap×k vs 對手 |
| `USR41` + `@MWU` + `LAW-WX10` | **熟練度**：魂穿開局皆**初学乍練**；僅里程碑升級；靈魂圖書館不算武功 |
...
| `USR46` + `LAW-WX11` + `ART01` | **太玄調息**：專拍修內功可回氣血／內力／略降疲勞；初学乍練有上限與走火風險 |
...
**LAW 撰寫原則：** `mechanism`＋`constraint` 只寫短碼；**禁寫死主角姓名**（LAW-NAME01）——存 `@USR03`。**禁在 `@LAW` 內綁定特定角色 id 或姓名**；角色語氣由 `@NPC.特徵`／`@PRS`／`@PTY` 與 `features` 接線落實。
...
**中文欄位：** Tag map 欄位名不出現在 warm；欄位值用繁體短碼；正文不得逐字複誦圖（LAW-OUT05）。
...
- **世界觀雙層（USR26 + LAW-G14 + LAW-G04）：** 本作**時代底層為晚明**，重大**歷史事件與歷史人物須先擬真**（年號、官制、賦役、物價、江南社會情勢宜 plausible），再允許劇情**架空偏離**史書細節；**武學與江湖規則**則架空於**金庸武俠宇宙**（內力、門派生態、武學品級、奇遇邏輯可取金庸譜系，如太玄經、獨孤九劍等，見 `@USR04`／`@PLR`）。**分層原則：** 官府、戶籍、商路、工藝、戰爭大事→晚明擬真；武功、幫會、江湖規矩→金庸式；**禁**無故混入其他 IP 或現代梗入旁白。與 **LAW-PROSE01**／**USR20** 語體參照一致。
- **武學判定（USR27–29 + LAW-WX01–10 + `@WUX` + `@ART` + `@MWU`）：** 金庸架空面須有**內功、武學、輕功**與**各招熟練度**等機械判定；**各武功強弱不同**（`@ART` 係數），**同一武功亦看熟練度**（`@MWU`）。
  - **三欄分工：**
  ...
  - **熟練度成長（USR41 + LAW-WX10）：** 與四維相同，**僅里程碑**（長時修練結算、實戰突破、章節收束等）可讓指定 `@MWU` **+1 當值**（最多升至登峰造極 5）；**禁**每拍選項自動升熟練度。同一里程碑同一門武功最多 +1。
  - **有效戰力（LAW-WX04 + LAW-WX08）：** **cap_idx**＝min(**本拍 `@MWU` 當值**, 對應 `@WUX` 門類當值, 歲數上限, 內力是否支撐)；**eff_idx**＝round(cap_idx × **art_k**)，上限 5。`@OLN` 須標**本拍武功**（`@ART` id／名）。
  - **`@WUX`（肉身門類）：** 開局硝：內功未入門、武學／輕功初学乍練。
  - **`@USR04`（技能清單摘要）：** 武功皆标**初学乍練**；靈魂圖書館仍**登峰造極**（知識庫，非 MWU）。
  - **武功特例（USR40 + LAW-WX09）：**
    - **六脈神劍（ART03）：** k＝1.90；內力 &lt;7 時 k 降至 **1.10**（指力難續）；內力代價 **×2**（LAW-WX09→WX06）
    - **獨孤九劍（ART02）：** 拆招／料敵場面；`@TRT` 智力 ≥2 時 margin **+1**（破招加成，每場一次）
    - **凌波微步（ART04）：** **僅**在輕功／躍避／脫身主導時乘 k；純兵刃對拆**不**用此 k，改算 WUX03
    - **太玄經（ART01）：** **綜合**；運內時乘 WUX01、拆招時乘 WUX02，皆用 k＝1.75；**內功功效**見 **LAW-WX11**（調息回氣血／內力）
  - **一般成敗（LAW-WX03 + LAW-PERS04）：** 非交手場面用情境 DC + 修正；若涉及武功（躍牆等），eff_idx 仍可乘對應 `@ART` 的 k。
  - **過招／輸贏（USR35–37 + LAW-WX05–07 + LAW-WX08）：** 拆招、比武、實戰等須分勝負時走交手判定。
    1. **`@OLN` 先標：** `交手模式`（`USR35`）、`本拍武功`（`@ART` 名或 id）、`對手武功`（`@ART` 或 `@NPC.技能`）、`對手品級`（`USR28` 名或索引）。
    2. **對手戰力（LAW-WX07 + LAW-WX08）：** 對手 **opp_idx**＝round(對手品級索引 × 對手 **art_k**)；無名把式 k＝1.00；三流鏢師用 ART21 k＝0.80 等。
    3. **己方戰力：** **eff_idx**＝round(cap_idx × 本拍 art_k)，cap_idx 來自 LAW-WX04；門類須與 `@ART.門類` 或本拍寫法一致（綜合可擇一維）。
    4. **差距 margin**（正文不報數）：
       - **基底**＝eff_idx − opp_idx
       - **修正（`USR37`）：** 內功／輕功／四維／狀態／兵刃／地形／偷襲／人數（同前）；**獨孤破招**另 +1（見上）
         - 內功有效索引 ≥2 且內力 ≥3：**+1**（運氣護招）；內力 &lt;3：**−1**（LAW-WX02 走形）
  ...
  - **內力消耗（LAW-WX02）：** 內力不足時禁寫滿血大招；宜寫氣短、招式走形或改以匠藝／智力選項應對。
...
- **身體狀態與劇情（USR45 + LAW-VIT01 + `@PLR.身體狀態`）：** HUD 尾欄與圖上 `@PLR` 第 7 欄（`氣血`／`內力`／`內功`／`武學`／`輕功`／`飽食`／`疲勞` 等）**不是裝飾**，每拍必納入編排與正文。
  ...
  - **六選項（opt_respect，`LAW-OPT01` cite）：** 選項須**可信**於當前狀態——過勞（疲勞 ≥8）或氣血 ≤3 時，**禁**六項全是高強度體力／通宵；宜含歇息、進食、請姊妹代勞、改日再辦等路線，或由 NPC 當場勸阻。圖書館（6）與產業帳（5）不受體力門檻限制，但正文仍可寫「蹲著查閱、眼皮打架」。**氣血＝0 或 `昏厥:是` 時 `LAW-VIT03` 覆寫 `LAW-OPT01`（`vit03_suspend`）——見下方，禁呈現六選項。**
  - **落盤（finish_delta）：** 體力消耗拍 `beat_turn_finish` **須** `update @PLR` 身體狀態。參考代價（可疊加，Integrator 心算）：
    ...
    | 交手 | 見 **LAW-WX06** | 見 **LAW-WX06** | — | 見 **LAW-WX06** |
  ...
  - **氣血歸零（USR50 + LAW-VIT03，每拍 warm）：** `氣血:0`＝**肉身昏厥／失能**，魂穿意識可殘留模糊感知，**禁**當作「還能正常幹活」。
    - **觸發：** 本拍 `finish_delta` 或交手代價（**LAW-WX06**）使氣血降至 **0**；`@PLR.身體狀態` 宜加 **`昏厥:是`**（醒復後刪或改 `否`）。
    - **正文（collapse）：** 須寫倒地、視界发黑、耳鳴、四肢不聽使喚；內心可短句斷片（**禁**長篇正常行動）。若當場有人（沈芯、沈蘭等），須寫其驚扶、呼喊、搬抬。
    - **自動敘事拍（`auto_beat`，`LAW-PIPE23` + `USR50.no_opts`）：** 昏厥中**玩家無法選項**——`LAW-OPT01` 整條 **suspend**（禁列 1–6、禁產業帳、禁圖書館）。流程改為：
    ...
    - **交手（`LAW-WX05`）：** 氣血已 **0** 或本拍將歸零 → **自動敗北／被制**；不得再發招反勝；對手可補刀敘事但**本作禁寫主角當場身死**（`no_permadeath`）。
    - **調息（`LAW-WX11`）：** **禁**——昏厥中無法盤膝運氣；須先醒復至 **氣血≥1**。
  ...
  - **恢復（禁無代價回滿）：** 僅**明確歇息拍**（睡眠數時辰）、**進食拍**、**太玄調息專拍**（**LAW-WX11**）、療傷里程碑 可回升。恢復**不得超過當前上限**（**LAW-VIT02**）。參考：熟睡一夜 疲勞 −3～−5、氣血 +1～+2；飽餐一頓 飽食升一檔。**昏厥中**僅 **照料醒復拍**（見 **LAW-VIT03**）可脫離 **0**，調息與圖書館不算。
  - **氣血／內力上限（USR47–49 + LAW-VIT02，每拍 warm）：**
    - **分兩層：** **當前值**（池裡剩多少）≠ **上限**（池子多大）。`@PLR.身體狀態` 宜寫 **`氣血:cur/max；內力:cur/max`**（禁寫死 `/10`）。
    - **設計原則（消耗定上限）：** 內力上限須能通過 **「本拍武功」的交手消耗**（**LAW-WX06** × **LAW-WX09**／`USR49`）反推合理性：
    ...
    - **升上限（里程碑，禁每拍）：** `WUX01`（內功門類）升一檔 → 查主修表跳一列；歲數每 +2 年 → `age_bonus+1`。`MWU` 熟練度**不直接**漲池，但高 MWU 降有效 burn（敘事／margin），與 **LAW-WX04** 一致。
  ...
  - **太玄經調息（USR46 + LAW-WX11 + ART01／MWU01／WUX01，每拍 warm）：**
    ...
    - **`@WUX01`（內功門類）：** 首次**順調**里程碑可自「未入門」升至「初学乍練」（同 **LAW-WX10** 節奏，一生一次）。
    - **finish：** 調息專拍須 `update @PLR`；與 **LAW-VIT01** `finish_delta` 連動。
  - **與武學分工：** 交手 margin／代價仍走 **LAW-WX05–07**；`LAW-VIT01` 管**日常劇情與匠活**亦須付體征代價，並要求選項／OLN 不脫節。
- **四維與判定（USR33–34 + LAW-PERS03–04 + `@TRT` + `@GLO01–04`）：**
  ...
  - **禁**「選過力量選項就自動成功」；**禁**無 DC 的無限膨脹四維。與 **LAW-WX03** 一般判定並用；**過招／比武／實戰**則必走 **LAW-WX05–07** 輸贏帶，近身拆招看武學維＋力量修正；談判看魅力＋智力；賭運氣看氣運。
...
- **魂穿者語音分層（USR18/19 + USR24 + LAW-CHR01 + LAW-PROSE17）**：主角本質是21世紀台灣現代人，語風需分層處理：
  ...
  - 對白與內心合計比例仍受 LAW-PROSE02 約束。
- **LAW-CHR01 現在同時參照 USR24／USR25**：內心語風＋歲數綁定；外部表現仍受時代與對象約束。
- **年齡綁定（USR25 + LAW-CHR04 + LAW-PROSE18 + `@SYS01`／出生年）：** 每拍正文、對白、@OLN／@SBD／@SCR 須先算歲數＝`@SYS01` 西元年 − `@PLR`／`@NPC` 出生年。身形、力氣、稱謂、能承擔的工種須對齊；**禁**預設成年壯漢／「大哥」式成人稱呼（除非對象確實年長）。魂穿者：**心智可成年、肉身須年幼**——內心吐槽可成熟，手腳身高氣力描寫仍依歲數。
...
- **時代與架空（USR26／SYS01／CFG01）：** 崇禎十年（1637）江南為**晚明史實面**；江湖武學為**金庸武俠架空面**。史有名人物若出場，宜先依史實身分與行事邏輯推演，再因主角介入而偏離；虛構人物仍須貼晚明社會。武林事件、內力修為、門派設定不與正史對表，但不得與晚明行政經濟常識硬衝（如崇禎朝無電報卻有幫會火並可）。打鬥、身法、運氣須走 **LAW-WX** 判定；**過招須走 LAW-WX05 輸贏帶**，不得無成本滿級發招。
...
- **開局場景 SCN01 `smithy_gate`：** 沈家鐵坊門前甦醒；姊妹求聘小工；`E11` 待聘、`E01` 求助待解鎖。
