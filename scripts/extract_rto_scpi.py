...
def build_wire_prefix() -> str:
    ...
    return (
        """# =============================================================================
# LEFTOVER @TAG PIPE — import-once machine seed. NOT agent GQL wire.
# Do not teach this file as mutate. Product Commit is MCP/CLI mutate (CREATE/MATCH SET).
# leftover add still loads @TAG pipe. Map: schema.techdocs.example.txt.
# Regenerated by scripts/extract_rto_scpi.py. Do not hand-edit the body.
# =============================================================================
