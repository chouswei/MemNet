...
def main() -> None:
    head = [
        ...
        "# leftover add still loads @TAG pipe. Agent GQL seed: schema.coding.example.txt + workflow.coding.example.txt.",
        "# Regenerated by scripts/generate_memnet_codebase_seed.py. Do not hand-edit the body.",
        "# =============================================================================",
