...
Operational doctrine (developers): `docs/operations/multi-agent-sessions.md`. Application adoption (`modelbasedPrj-*`): `docs/application-notes/system/llm-system-dev-multitask.md`. Index: `docs/README.md`.
