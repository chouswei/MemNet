...
| [session-import-case-study.md](session-import-case-study.md) | Colloquial session merge = lead **receives** member WM; ImportGuard soft gate | S10...S12; SessionMergeFraming; librarian analogy |
