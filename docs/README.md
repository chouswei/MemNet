...
| [`grammar/memnet-harness-thesis.md`](grammar/memnet-harness-thesis.md) | Design thesis: harness memory plane; GitHub harnesses elide/trim/summarise chat, not `pin_map` |
