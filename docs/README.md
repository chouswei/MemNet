...
| [`ROADMAP.md`](ROADMAP.md) | **SemVer SSOT** — locked `a.b.c`; extras 0.10–0.19 in Hatch **0.19.7** |
...
| [`operations/honesty-c-wire-audit.md`](operations/honesty-c-wire-audit.md) | 0.19.7 catalog leftover nick + Truncation + hid emit audit |
