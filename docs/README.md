...
| [`ROADMAP.md`](ROADMAP.md) | **Version map SSOT** — one picture; 1.0 = claim; planned extras 0.10–0.19 |
...
| [`grammar/neo4j-buffer.md`](grammar/neo4j-buffer.md) | MemNet ↔ Neo4j; RAG relatives on Snap / Shape / cabinet; live claimed (0.14) |
