...
| `docs/grammar/memnet-multi-layer.md` | Capsules / stratified pin maps; **§3.7 ports-first** elevates port→port `derives` for capsule interiors (design; ahead of this doc’s cross-node “later”) |
