...
**Status:** version map SSOT [`../ROADMAP-0.5.md`](../ROADMAP-0.5.md). 0.7 live cabinet **shipped**. **0.8** is teach/shape (#87), not a second cabinet claim. Server not vendored. Fake + skip unless `MEMNET_AGENSGRAPH_URL` is set.  
