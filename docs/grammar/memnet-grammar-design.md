...
| `docs/grammar/memnet-multi-layer.md` | **Design:** stratified pin maps + Capsule (`CAP`) / Port (`PORT`); `FN` ⊂ `CST`, law on node; EDGE = carrier; distinct from §3 I/O/store/transport layering |
