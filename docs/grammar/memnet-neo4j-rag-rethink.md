...
**Status:** option **B namespaces** shipped as extra **0.16** (in package 0.19.1). Host Snap (`RagHostHook.implemented=true`) extra **0.17**. Does **not** amend [`../SHAPE.md`](../SHAPE.md) beyond the 0.16 locator port.  
