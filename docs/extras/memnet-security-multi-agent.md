...
**Dialect:** agent-facing I/O is **GQL only** ([`gql-wire-profile.md`](../grammar/gql-wire-profile.md)). No `@TAG|pipe` teach; no Layer. ASCII property values.  
...
| [`gql-wire-profile.md`](../grammar/gql-wire-profile.md) | Agent wire; leftover `id` is a nickname |
