...
| [`llm-system-dev-multitask.md`](system/llm-system-dev-multitask.md) | Multitask in `modelbasedPrj-*` / `SysMLEdgePrj-*` (MemNet working memory; repo-based or SysMLEdge-based host) | sysml + coding (+ ingest maps as needed) |
