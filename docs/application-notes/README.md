...
| [`llm-sysml-v2-modeling.md`](llm-sysml-v2-modeling.md) | SysML SSOT; `pin_map` relatives (\(\approx 1\)–\(2\,\mathrm{k}\) vs dump) | `schema.sysml.example.txt` **union** `schema.coding.example.txt` |
