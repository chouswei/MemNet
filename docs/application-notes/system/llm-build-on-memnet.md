...
Optional-deps keep `pip install memnet-llm` lightweight; only `[mcp]` users pull the `mcp` package. Hatch **0.19.12**; last published PyPI is **`memnet-llm==0.19.11`**: `pip install 'memnet-llm[mcp]'` (contributors: `pip install -e ".[mcp]"`).
